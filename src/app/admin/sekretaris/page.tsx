  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-3xl shadow-sm transition-colors">
        <div>
          <div className="flex items-center gap-2 text-xs font-bold text-red-600 dark:text-red-400 uppercase tracking-wider mb-1">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800/50 text-red-700 dark:text-red-300">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 font-bold text-xs transition active:scale-95"
          >
            <Mail className="w-4 h-4 text-red-600 dark:text-red-400" /> Surat Masuk & Keluar
          </Link>
        </div>
      </div>
      ...
      {expiringDokumen.length > 0 && (
        <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800/50 rounded-2xl p-4 flex items-start gap-3 shadow-sm">
          <AlertTriangle className="w-5 h-5 text-amber-600 dark:text-amber-400 shrink-0 mt-0.5" />
          <div className="flex-1 text-xs text-amber-900 dark:text-amber-200">
            <span className="font-bold text-amber-950 dark:text-amber-100">Peringatan Masa Berlaku SK Dokumen:</span> Terdapat{" "}
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {expiringDokumen.map((doc) => (
                <span key={doc.id} className="inline-block bg-amber-100 dark:bg-amber-900/60 border border-amber-300 dark:border-amber-700 px-2.5 py-1 rounded-lg font-mono text-[11px] text-amber-950 dark:text-amber-200">
          ...
          <Link
            ...
            className="px-3 py-1.5 rounded-xl bg-amber-600 hover:bg-amber-700 text-white font-bold text-xs transition shrink-0"
          >
            Perbarui SK
          </Link>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-2xl shadow-sm hover:border-slate-300 dark:hover:border-slate-700 transition">
          ...
          <div className="text-2xl font-black text-slate-900 dark:text-white">{totalSuratKeluar}</div>
          <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">Surat resmi diterbitkan</div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-2xl shadow-sm hover:border-slate-300 dark:hover:border-slate-700 transition">
          ...
          <div className="text-2xl font-black text-slate-900 dark:text-white">{totalSuratMasuk}</div>
          <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">Surat masuk registered</div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-2xl shadow-sm hover:border-slate-300 dark:hover:border-slate-700 transition">
          ...
          <div className="text-2xl font-black text-amber-600 dark:text-amber-400">{pendingApproval}</div>
          <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">Draft menunggu TTD</div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-2xl shadow-sm hover:border-slate-300 dark:hover:border-slate-700 transition">
          ...
          <div className="text-2xl font-black text-slate-900 dark:text-white">{totalDokumen}</div>
          <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">Arsip berkas digital</div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 rounded-2xl shadow-sm hover:border-slate-300 dark:hover:border-slate-700 transition">
          ...
          <div className="text-2xl font-black text-slate-900 dark:text-white">{totalRapat}</div>
          <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-1">Risalah & action items</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        <Link
          href="/admin/sekretaris/generator"
          className="group p-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-red-300 dark:hover:border-red-500/50 rounded-2xl transition shadow-sm hover:shadow-md flex flex-col justify-between"
        >
          <div>
            <div className="w-10 h-10 rounded-xl bg-red-50 dark:bg-red-950/40 text-red-600 dark:text-red-400 flex items-center justify-center mb-3 font-bold group-hover:scale-110 transition">
              <FileSpreadsheet className="w-5 h-5" />
            </div>
            <h3 className="font-bold text-slate-900 dark:text-white text-base group-hover:text-red-600 dark:group-hover:text-red-400 transition">
          ...
          <div className="mt-4 flex items-center text-xs font-bold text-red-600 dark:text-red-400 gap-1">
        ...
        <Link
          href="/admin/sekretaris/surat"
          className="group p-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-500/50 rounded-2xl transition shadow-sm hover:shadow-md flex flex-col justify-between"
        >
          <div>
            <div className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-3 font-bold group-hover:scale-110 transition">
        ...
        <Link
          href="/admin/sekretaris/dokumen"
          className="group p-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-emerald-300 dark:hover:border-emerald-500/50 rounded-2xl transition shadow-sm hover:shadow-md flex flex-col justify-between"
        >
          <div>
            <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-3 font-bold group-hover:scale-110 transition">
        ...
        <Link
          ...
          className="group p-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-purple-300 dark:hover:border-purple-500/50 rounded-2xl transition shadow-sm hover:shadow-md flex flex-col justify-between"
        >
          <div>
            <div className="w-10 h-10 rounded-xl bg-purple-50 dark:bg-purple-950/40 text-purple-600 dark:text-purple-400 flex items-center justify-center mb-3 font-bold group-hover:scale-110 transition">
              <CalendarDays className="w-5 h-5" />
            </div>
            <h3 className="font-bold text-slate-900 dark:text-white text-base group-hover:text-purple-600 dark:group-hover:text-purple-400 transition">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
            <h2 className="font-bold text-slate-900 dark:text-white text-lg flex items-center gap-2">
              <FileText className="w-5 h-5 text-red-600 dark:text-red-400" /> Surat Terkini
            </h2>
            <Link
              href="/admin/sekretaris/surat"
          ...
          {recentSurat.length === 0 ? (
            <div className="text-center py-12 text-slate-500 dark:text-slate-400 text-xs border border-dashed border-slate-200 dark:border-slate-800 rounded-2xl bg-slate-50/50 dark:bg-slate-950/50">
            ...
            <div className="divide-y divide-slate-100 dark:divide-slate-800">
              {recentSurat.map((item) => (
                <div key={item.id} className="py-3 flex items-center justify-between gap-4 hover:bg-slate-50/80 dark:hover:bg-slate-800/40 px-2 rounded-xl transition">
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 text-xs font-mono text-red-600 dark:text-red-400 font-bold">
                      ...
                      <span className="text-slate-500 dark:text-slate-400 font-sans">{new Date(item.tanggalSurat).toLocaleDateString("id-ID")}</span>
                    </div>
                    <div className="font-bold text-slate-900 dark:text-slate-100 text-sm truncate mt-0.5">{item.perihal}</div>
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
            <h2 className="font-bold text-slate-900 dark:text-white text-lg flex items-center gap-2">
              <CalendarDays className="w-5 h-5 text-purple-600 dark:text-purple-400" /> Agenda & Risalah Rapat
            </h2>
            <Link
              href="/admin/sekretaris/rapat"
              className="text-xs text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-bold flex items-center gap-1"
            >
          ...
          {recentRapat.length === 0 ? (
            ...
            <div className="space-y-3">
              {recentRapat.map((rapat) => (
                <div key={rapat.id} className="p-3.5 bg-slate-50 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-800 rounded-2xl space-y-1.5 hover:bg-slate-100/60 dark:hover:bg-slate-800 transition">
                  ...
                  <div className="font-bold text-slate-900 dark:text-white text-sm">{rapat.judulRapat}</div>
                  <p className="text-xs text-slate-600 dark:text-slate-400 line-clamp-2">{rapat.agenda}</p>
                </div>
              ))}
            </div>
          )}
