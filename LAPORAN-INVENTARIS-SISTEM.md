...
13. Toolbar cabang: **Buat Periode**, Hari-H, **Laporan/Rekapan** (hub Peserta/Hasil/Administrasi), Laporan WA, **Salin Undangan** / **WA Undangan**, Cetak Nota (Print saja), Biaya Sabuk, Arsip (tombol terpisah). Toolbar ranting: **Laporan/Rekapan** (Peserta+Hasil scoped) + **Laporan WA** + **Salin/WA Undangan** + **Cetak Nota** (manual). Sama di **Arsip UKT**. Roster publik: `/ukt`.
