...
10b2. **Hub Laporan/Rekapan UKT** (tombol **Laporan/Rekapan** di toolbar, Pendaftaran + Arsip): modal ber-tab `UktReportsHubModal` — **Peserta** (export daftar: ranting/CSV/Print; floating Export multi-select juga membuka tab ini), **Hasil Ujian** (rekap Pengda Excel/Print + pejabat/penguji/TTD), **Administrasi** (Perincian setor Pengprov — **cabang saja**; ranting tidak melihat tab ini). Default tab **Hasil Ujian** jika sudah ada Kyu Baru, selain itu **Peserta**. Tombol **Unduh PDF** di hub & Cetak Nota dihapus (Save as PDF lewat dialog Print browser).
