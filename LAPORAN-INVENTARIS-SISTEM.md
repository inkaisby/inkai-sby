...
| Kwitansi Pembayaran | Grup nav **Pembuatan** `/admin/kwitansi` + **Arsip** `/admin/kwitansi/arsip`; logo INKAI + kop Cabang Surabaya + cap LUNAS; mode Per Penerima (multi-halaman / bebas pilih halaman print) vs Rangkuman; kolom **Aksi** di Arsip (Cetak, Edit, Hapus + konfirmasi); simpan arsip; export CSV rekap; nomor KW/NP berurutan; TTD jelas; `openHtmlPrintWindow` 1× (shared UKT/Latber); grant + preset bendahara |
