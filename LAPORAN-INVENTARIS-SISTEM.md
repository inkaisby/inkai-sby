...
10a. **Laporan WA ranting:** daftar peserta terdaftar (isUktWaRosterRow) + **rincian A/B/C/TOTAL (A+B−C)** selaras Nota (uang dari isUktNotaRow, B=0 di WA) + pecahan Sudah lunas / Belum lunas. WA cabang: **ringkas** (Pelaksanaan + *Jumlah UKT* + pecahan Lunas/Belum lunas rupiah + tempat/lokasi + *N Ranting* dengan Lunas/pecahan + jumlah kyu) atau **rinci per ranting**; picker = semua ranting di tabel (bukan hanya Menunggu Verifikasi/lunas); tombol **Salin laporan** (clipboard); rekap sabuk **Kyu Lama**.
