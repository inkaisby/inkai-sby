...
| `/ukt` | **Roster peserta UKT publik** (tanpa login, `noindex`): periode non-arsip term berjalan; kolom No/Foto/NIA/Nama/Kyu Lama/Kyu Baru/Ranting/Status; KPI + cari filter-only + ringkasan HP; poll senyap ~30s; **bukan** daftar UKT |
...
/api/admin/members/[id]     Detail + aksi (approve/NIA/set_name/set_msh/set_rank/set_dojo/set_dues/set_dues_exemption/dokumen/set_photo/reset_password/nonaktif/hapus/restore/merge); set_nia auto-provision jika belum berakun
