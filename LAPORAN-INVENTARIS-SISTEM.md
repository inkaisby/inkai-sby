...
| Kwitansi Pembayaran | Wireframe | `/admin/kwitansi` + `/admin/kwitansi/arsip` (dummy); mode A centang; draft sessionStorage; cetak 1× helper bersama; watermark DRAFT; PaymentReceipt **fase 2** |
