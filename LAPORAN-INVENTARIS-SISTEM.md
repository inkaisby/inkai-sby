...
| Refresh tabel UKT | Aktif | `GET /api/admin/ukt/table` snapshot + hydrate identitas Prisma (Tempat/TTL/JK/Alamat/Foto) + `registeredAt`; full halaman in-app Maximize (header Refresh/Cetak, Kyu Lama+Baru select cabang) |
