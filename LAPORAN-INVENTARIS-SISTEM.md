...
| Kwitansi Pembayaran | Nav **Kwitansi** `/admin/kwitansi` + **Arsip** `/admin/kwitansi/arsip` di bawah Keuangan; logo INKAI + kop Cabang Surabaya + cap LUNAS; mode Per Penerima vs Rangkuman; kolom **Aksi** di Arsip; simpan arsip + jurnal Kas (kecuali jenis iuran); export CSV rekap; nomor KW/NP; TTD; `openHtmlPrintWindow`; grant + preset bendahara + Kas |
