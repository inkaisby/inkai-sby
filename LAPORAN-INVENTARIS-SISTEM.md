...
6. Nota/rekap: peserta **lunas\|tunai** (`isLatberPaidStatus`); `grandTotal = (n × 45.000) − (n × 5.000)`; **Cetak Nota** kolom No·NIA·Nama·Sabuk·**Status**·**Hadir ☐**·Biaya; Rekap/Laporan WA/Undangan.
