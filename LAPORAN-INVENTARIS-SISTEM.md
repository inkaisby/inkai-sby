...
| 9 September 2026 | **Pemisahan Otomatis Grup Kegiatan Latber & UKT di Kas (`src/lib/kas.ts`):** Memperbaiki fungsi `getKasBaseKegiatan` agar transaksi ber-tipe atau berkegiatan `latber` (seperti `Ranting Bayar Latber UKT ...`) dikelompokkan secara terpisah ke dalam grup **`Bayar Latber UKT Semester II-2026`** dan tidak lagi tercampur/tergabung dengan transaksi pendaftaran UKT (**`Bayar UKT Semester II-2026`**); inventaris §6/§9/§15 |
