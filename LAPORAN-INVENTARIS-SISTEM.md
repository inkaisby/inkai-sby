...
| 25 Agustus 2026 | **Fix Rekapitulasi Setoran Kas UKT Net:** `aggregateKasByDojo` (`src/lib/kas.ts`) & `postKasFromUktPaid` (`src/lib/kas-hooks.ts`) kini menghitung nominal **Net UKT** (Subtotal A kotor − Komisi Ranting Rp 50.000/orang), sehingga pada modal **Rekapitulasi Setoran Masuk Per Ranting** (`/admin/kas`), Ranting **FORTRESS** mencatat **UKT (Lunas) = Rp 2.725.000,-** dan **Komisi UKT = Rp 550.000,-**, 100% selaras dengan Nota UKT dan Kas Cabang Net; inventaris §9.3c/§15 |
