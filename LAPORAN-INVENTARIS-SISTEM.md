...
| Sekretariat | Grup **Sekretariat** (`/admin/sekretaris`): **Dashboard Sekretariat** (`/admin/sekretaris`), **Surat & Persuratan** (`/admin/sekretaris/surat`), **Generator Surat** (`/admin/sekretaris/generator`), **Dokumen & SK** (`/admin/sekretaris/dokumen`), & **Notulen Rapat** (`/admin/sekretaris/rapat`); 100% mendukung dual mode toggle terang & gelap (`dark:`); penomoran otomatis `[No]/INKAI-KOTA.SBY/[Kode]/[Bulan-Romawi]/[Tahun]`, generator cetak A4/F4 presisi 1:1 Kop FORKI & INKAI, WYSIWYG Rich Text toolbar (Font Family/Size/Bold/Italic/Underline/Align), TTD Digital/Manual/Draw, QR Code verifikasi publik (`/v/surat/[id]`), delivery ke portal & notifikasi anggota (`/dashboard/dokumen`), kearsipan SK pengurus dengan alert kadaluarsa, & notulensi rapat dengan action items & salin format WA |
