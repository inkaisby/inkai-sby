...
5. **Ranting** — aksi baris: **Daftar UKT**, **Terima**/**Tolak** (mandiri), **Batal UKT** (hanya **Belum Bayar** & **Menunggu Verifikasi** — setelah cabang verifikasi / **Menunggu Ujian+** hanya cabang), **Bayar UKT** (= ajukan ke cabang → **Menunggu Verifikasi**; untuk jalur daftar ranting). Setelah daftar ranting: **Belum Bayar**. **Hapus tagihan** (cabang, hanya bila tagihan **lunas** / **Menunggu Ujian+**; tidak di Belum Bayar / Menunggu Verifikasi): pendaftaran tetap → tagihan PENDING baru, status **Belum Bayar**, ranting **Bayar UKT** lagi (salah hapus/refund); **Hapus** pendaftaran cabang = hapus peserta + tagihan (keluar daftar). Notifikasi otomatis daftar/batal/Bayar/Terima.
