...
| 14 September 2026 | **Akumulasi Saldo Per Kegiatan Seperti Spreadsheet (`src/lib/kas.ts` & `KasLedgerClient.tsx`):** Meng-update `groupKasTable` agar setiap baris di dalam grup kegiatan kas menghitung akumulasi saldo berjalan khusus kegiatan tersebut secara berurutan linier berdasarkan Masuk & Keluar (`150rb ➔ 400rb ➔ 900rb ➔ 1.100rb ➔ 2.100rb ➔ 2.950rb ➔ 3.150rb`), persis seperti format lembar kerja Excel/Spreadsheet per kegiatan tanpa terpengaruh lompatan tanggal mutasi kegiatan lain; inventaris §6/§9/§15 |
